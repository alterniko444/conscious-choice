...
<?php include 'session_check.php'; ?>
    ...
    <button class="b1" name="button" value="PONDS">PONDS</button>
    <button class="b2" name="button" value="MAYBELLINE">MAYBELLINE</button>
    <button class="b3" name="button" value="OLDSPICE">OLD SPICE</button>
    </form>
    </div>
</body>
</html>