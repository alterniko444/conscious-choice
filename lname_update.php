...
<body>
    ...
    <div class="two">
        ...
        <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
            <p class="hey3">Enter Last Name</p>
            <input type="text" class="heyb1" name="lname" required>
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            echo "<script>alert('Last name updated successfully!');window.location.href='user_profile.php'</script>";
