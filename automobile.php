...
<?php include 'session_check.php'; ?>
    ...
    <button class="b1" name="button" value="BENZ">MERCEDES BENZ</button>
    <button class="b2" name="button" value="SUZUKI">MARUTI SUZUKI</button>
    <button class="b3" name="button" value="MITSUBISHI">MITSUBISHI</button>
    </form>
    </div>
</body>
</html>