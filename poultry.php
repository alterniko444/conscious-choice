...
<?php include 'session_check.php'; ?>
    ...
    <button class="b1" name="button" value="MEETATMEAT">MEET AT MEAT</button>
    <button class="b2" name="button" value="EGGS">RAJEEV EGGS</button>
    <button class="b3" name="button" value="FRESHSERVE">FRESH AND SERVE LMT</button>
    </form>
    </div>
</body>
</html>